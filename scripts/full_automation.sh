...
echo "🚀 Starting Full Automated DevOps Flow (Villa Booking App)..."
...
FRONTEND_IMAGE="$DOCKERHUB_USER/villa-booking-frontend:latest"
BACKEND_IMAGE="$DOCKERHUB_USER/villa-booking-backend:latest"
...
echo "🎯 Villa Booking Frontend & Backend are running in Azure using DockerHub images."
