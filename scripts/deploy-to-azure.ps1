# Deploy Villa Booking Application to Azure
...
Write-Host "Villa Booking - Azure Deployment" -ForegroundColor Cyan
Write-Host "==========================================" -ForegroundColor Cyan
...
if (-not (Test-Path "terraform.tfvars")) {
    ...
    $tfvars = $tfvars -replace 'backend_image = ""', "backend_image = `"${DockerHubUsername}/villa-booking-backend:latest`""
    $tfvars = $tfvars -replace 'frontend_image = ""', "frontend_image = `"${DockerHubUsername}/villa-booking-frontend:latest`""
